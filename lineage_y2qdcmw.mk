...
# Build info
BUILD_FINGERPRINT := "samsung/SC-52A/SC-52A:10/QP1A.190711.020/SC52AOMU1ATD8:user/release-keys"
PRODUCT_BUILD_PROP_OVERRIDES += \
    PRODUCT_DEVICE=y2q \
    PRODUCT_NAME=y2qdcmw \
    TARGET_DEVICE=SC-52A \
    PRIVATE_BUILD_DESC="y2qdcmw-user 10 QP1A.190711.020 SC52AOMU1ATD8 release-keys" \
    BUILD_DISPLAY_ID="$(BUILD_ID).SC52AOMU1ATD8" \
    BUILD_NUMBER=SC52AOMU1ATD8 \
